                ...
                <?php foreach ($result as $row): ?>
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nisn" value="<?= $row['nisn'] ?>" disabled>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nik" value="<?= $row['nik'] ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="kelas" value="<?= $row['kelas'] ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="role_name" value="<?= $row['role_name'] ?>"
                                    disabled>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nomor_hp" value="<?= $row['nomor_hp'] ?>"
                                    disabled>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="alamat" value="<?= $row['alamat'] ?>" disabled>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="container mb-3 d-flex justify-content-end">
                            <a href="index.php?page=edit_user&id=<?= $row['id'] ?>" disabled class="btn btn-primary">
                                Edit
                            </a>
                        </div>
                    </div>
